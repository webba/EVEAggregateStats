...
export class LoyaltyService {
     ...
     */
    public getCharactersCharacterIdLoyaltyPoints(characterId: number, datasource?: string, token?: string, userAgent?: string, xUserAgent?: string, extraHttpRequestParams?: any): Observable<Array<GetCharactersCharacterIdLoyaltyPoints200Ok>> {
     ...
     * @param xUserAgent Client identifier, takes precedence over User-Agent
     */
    public getLoyaltyStoresCorporationIdOffers(corporationId: number, datasource?: string, userAgent?: string, xUserAgent?: string, extraHttpRequestParams?: any): Observable<Array<GetLoyaltyStoresCorporationIdOffers200Ok>> {
    ...
    public getCharactersCharacterIdLoyaltyPointsWithHttpInfo(characterId: number, datasource?: string, token?: string, userAgent?: string, xUserAgent?: string, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + '/v1/characters/${character_id}/loyalty/points/'
    ...
    public getLoyaltyStoresCorporationIdOffersWithHttpInfo(corporationId: number, datasource?: string, userAgent?: string, xUserAgent?: string, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + '/v1/loyalty/stores/${corporation_id}/offers/'
